...
if (!$this->ion_auth->in_group(array('superadmin'))) {
    ...
    <head>
        ...
        <link href="common/assets/font-awesome-6/css/all.css" rel="stylesheet" />
                    ...
                    <a href="" class="logo">
                        <strong style="color:white;">
                            <?php echo $settings_title[0]; ?> <span><?php
                                                            ...
                                                            ?></span>
                                                            <?php echo $settings_title[2]; ?><span> <?php
                                                                                            if (!empty($settings_title[3])) {
                                                                                                echo $settings_title[3];
                                                                                            }
                                                                                            ?></span>
                        </strong>
                    </a>
            ...
            <aside>
                <div id="sidebar"  class="nav-collapse">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <?php ?>
                            <li><a href="settings/language"><i class="fa fa-globe"></i><?php echo lang('language'); ?></a></li>
                        <?php ?>
