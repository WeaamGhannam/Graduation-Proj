...
// Validating Deposited Amount Field
    ...
    function getPatient() {
        ...
        foreach ($data['patients'] as $patient) {
            ...
            if ($this->ion_auth->in_group(array('admin', 'Accountant', 'Receptionist', 'Nurse', 'Doctor'))) {
            ...
            if ($this->ion_auth->in_group(array('Accountant', 'Receptionist'))) {
                $info[] = array(
                    ...
                    $patient->phone,
                    $patient->bloodgroup,
                    $options1 . ' ' . $options3 .  ' ' . $options6 . ' ' . $options5,
                        //  $options2
                );
            }
