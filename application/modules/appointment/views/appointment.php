            ...
            <div class="col-md-12">
                <header class="panel-heading tab-bg-dark-navy-blueee row">
                    <ul class="nav nav-tabs col-md-8">
                        ...
                        <li class="">
                            <a data-toggle="tab" href="#unpaid"><?php echo lang('unpaid'); ?></a>
                        </li>
                         <li class="">
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($appointment_pendings as $appointment) { ?>
                                            <tr class="">
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($appointment_confirmeds as $appointment) { ?>
                                            <tr class="">
                                                <td ><?php echo $appointment->id; ?></td>
                                                <td>
                                                    <?php
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($appointment_treateds as $appointment) { ?>
                                            <tr class="">
                                                <td ><?php echo $appointment->id; ?></td>
                                                <td>
                                                    <?php
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($appointment_cancelleds as $appointment) { ?>
                                            <tr class="">
                                                <td ><?php echo $appointment->id; ?></td>
                                                <td>
                                                    <?php
                            ...
                            <div class="panel-body">
                                <div class="adv-table editable-table ">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                        ...
                                        <?php foreach ($appointment_requesteds as $appointment) { ?>
                                            <tr class="">
                                                <td ><?php echo $appointment->id; ?></td>
                                                <td>
                                                    <?php
